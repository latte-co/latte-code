...
- Global session and data storage: [English](en-US/design/data-storage.md) | [中文](zh-CN/design/data-storage.md)
- Slash commands: [English](en-US/design/slash-commands.md) | [中文](zh-CN/design/slash-commands.md)
