...
- [Global session and data storage](design/data-storage.md): proposed user-global SQLite catalog/control plane, workspace-grouped JSONL conversations, transient Draft/Provider failures, recovery, and migration contract.
- [Slash commands](design/slash-commands.md): proposed unified command catalog, composer popup, typed dispatch boundary, trusted prompt-command extension contract, and verification plan.
