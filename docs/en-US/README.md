...
- [Global session and data storage](design/data-storage.md): implemented configured database path, workspace-scoped Session catalog, scoped leases, and durable redacted Provider-configuration failures, plus the proposed global home, JSONL, recovery, and migration contract.
