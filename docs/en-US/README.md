...
- [Global session and data storage](design/data-storage.md): implemented global product home, Project/Workspace registration, Session-partitioned leases, per-Session JSONL read authority and tail repair, idempotent legacy import, and the remaining discovery/governance contract.
- [Slash commands](design/slash-commands.md): implemented built-in catalog, Session commands, and composer popup, plus proposed prompt-command extensions and remaining typed actions.
...
- [E2E authoring guide](testing/e2e-authoring-guide.md): feature-level UT/E2E policy, harness usage, assertion checklist, and the independent UT 95% / E2E 90% coverage measurements.
